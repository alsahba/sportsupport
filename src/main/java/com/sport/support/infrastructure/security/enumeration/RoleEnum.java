...
public enum RoleEnum {
  ...
  MEMBER(Set.of(MEMBER_WRITE, MEMBER_READ, USER_READ, USER_WRITE, EXERCISE_READ, PLAN_READ)),
  ...
  MANAGER(Set.of(MEMBER_READ, MEMBER_WRITE, USER_READ, USER_WRITE, BRANCH_READ, BRANCH_WRITE, TRAINER_WRITE, TRAINER_READ)),
